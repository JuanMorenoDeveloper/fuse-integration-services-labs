 ...
 * 2019-04-04T14:01:39.453-03:00
 * Generated source version: 3.2.7.fuse-730037
 *
 */
@WebServiceClient(name = "CustomerService",
                  wsdlLocation = "file:/E:/Dev/fuse-integration-services-labs/camel-webservice/src/main/resources/wsdl/CustomerService.wsdl",
...
public class CustomerService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Dev/fuse-integration-services-labs/camel-webservice/src/main/resources/wsdl/CustomerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/Dev/fuse-integration-services-labs/camel-webservice/src/main/resources/wsdl/CustomerService.wsdl");
        }
        WSDL_LOCATION = url;
    }
